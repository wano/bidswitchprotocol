...
import "github.com/mxmCherry/openrtb/openrtb2"
...
type Imp struct {
	...
	Metric []openrtb2.Metric `json:"metric,omitempty"`
	...
	Audio *openrtb2.Audio `json:"audio,omitempty"`
	...
	PMP *openrtb2.PMP `json:"pmp,omitempty"`
